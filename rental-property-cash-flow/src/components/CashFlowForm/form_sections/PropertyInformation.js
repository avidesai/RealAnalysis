    ...
    <div className="form-section">
      ...
      {isSTR ? (
        <div className="form-group">
          <label>
            Nightly Rate
            <InfoTooltip description="Average nightly rate you charge guests" />
          </label>
          <FormattedNumberInput step="10" name="nightlyRate" value={formData.nightlyRate || 0} onChange={handleChange} min={0} max={100000} />
        </div>
      ) : (
        <>
          <div className="form-group">
